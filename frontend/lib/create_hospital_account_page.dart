...
class CreateHospitalAccountPage extends StatefulWidget {
  const CreateHospitalAccountPage({super.key});

  @override
  State<CreateHospitalAccountPage> createState() =>
      _CreateHospitalAccountPageState();
}

class _CreateHospitalAccountPageState extends State<CreateHospitalAccountPage> {
  ...
  Future<void> _handleRegister() async {
    try {
      ...
      final result = await ApiService.registerHospital(
